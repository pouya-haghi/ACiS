...
ol.networklayer_0.sockets[1] = (sw_ip1, 38746, 62781, True) # This is used since we are using its port (38746) in remote NIC 1
ol.networklayer_0.sockets[2] = (sw_ip2, 60514, 62781, True) # This is used since we are using its port (60514) in remote NIC 2
ol.networklayer_0.populate_socket_table(debug=True)

lb = ol.krnl_loopback_0
size = 1408 * 100 # sum of all of elements from NIC 1 (1408*50) and (+) NIC 2 (1408*50). 
lb_wh = lb.start(size)
