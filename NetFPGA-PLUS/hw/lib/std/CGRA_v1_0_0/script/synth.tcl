...
puts "Creating CGRA"
# RTL kernel interfaces
####################################
# create_ip -name rtl_kernel_wizard -vendor xilinx.com -library ip -version 1.0 -module_name rtl_kernel_wizard_0
# set_property -dict [list CONFIG.KERNEL_NAME {rtl_kernel_wizard_0} CONFIG.NUM_RESETS {1} CONFIG.NUM_INPUT_ARGS {0} CONFIG.NUM_AXIS {2}] [get_ips rtl_kernel_wizard_0]
# generate_target {instantiation_template} [get_files ip/synth/CGRA.srcs/sources_1/ip/rtl_kernel_wizard_0/rtl_kernel_wizard_0.xci]
# generate_target all [get_files  ip/synth/CGRA.srcs/sources_1/ip/rtl_kernel_wizard_0/rtl_kernel_wizard_0.xci]
# catch { config_ip_cache -export [get_ips -all rtl_kernel_wizard_0] }
# export_ip_user_files -of_objects [get_files ip/synth/CGRA.srcs/sources_1/ip/rtl_kernel_wizard_0/rtl_kernel_wizard_0.xci] -no_script -sync -force -quiet
# create_ip_run [get_files -of_objects [get_fileset sources_1] ip/synth/CGRA.srcs/sources_1/ip/rtl_kernel_wizard_0/rtl_kernel_wizard_0.xci]
# launch_runs rtl_kernel_wizard_0_synth_1 -jobs 32
# export_simulation -of_objects [get_files ip/synth/CGRA.srcs/sources_1/ip/rtl_kernel_wizard_0/rtl_kernel_wizard_0.xci] -directory ip/ip_user_files/sim_scripts -ip_user_files_dir ip/ip_user_files -ipstatic_source_dir ip/ip_user_files/ipstatic -lib_map_path {vcs=ip/vcs} -use_ip_compiled_libs -force -quiet
