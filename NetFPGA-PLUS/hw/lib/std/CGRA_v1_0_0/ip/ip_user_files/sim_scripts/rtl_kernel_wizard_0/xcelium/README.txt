...
#
# Generated by export_simulation on Mon Apr 11 15:49:25 EDT 2022
#
################################################################################
...
'-reset_run' switch to the './rtl_kernel_wizard_0.sh' script.

./rtl_kernel_wizard_0.sh -reset_run
...
./rtl_kernel_wizard_0.sh -noclean_files

For more information on the script, please type './rtl_kernel_wizard_0.sh -help'.
