...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_LUT_DEPTH_BITS" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_LUT_DEPTH_BITS { PARAM_VALUE.C_LUT_DEPTH_BITS } {
	# Procedure called to update C_LUT_DEPTH_BITS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_LUT_DEPTH_BITS { PARAM_VALUE.C_LUT_DEPTH_BITS } {
	# Procedure called to validate C_LUT_DEPTH_BITS
	return true
}
...
proc update_MODELPARAM_VALUE.C_LUT_DEPTH_BITS { MODELPARAM_VALUE.C_LUT_DEPTH_BITS PARAM_VALUE.C_LUT_DEPTH_BITS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_LUT_DEPTH_BITS}] ${MODELPARAM_VALUE.C_LUT_DEPTH_BITS}
}
