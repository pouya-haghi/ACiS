...
#set_property -dict [list CONFIG.input_file $::env(NF_DESIGN_DIR)/test/nf_interface_0_stim.axi] [get_ips axis_sim_stim_ip0]  PH
set_property -dict [list CONFIG.input_file /home/haghi/my_temp/nf_interface_0_stim.axi] [get_ips axis_sim_stim_ip0]
...
set_property -dict [list CONFIG.input_file /home/haghi/my_temp/nf_interface_1_stim.axi] [get_ips axis_sim_stim_ip1]
...
set_property -dict [list CONFIG.input_file /home/haghi/my_temp/dma_0_stim.axi] [get_ips axis_sim_stim_ip2]
...
set_property -dict [list CONFIG.STIM_FILE /home/haghi/my_temp/reg_stim.axi CONFIG.EXPECT_FILE /home/haghi/my_temp/reg_expect.axi CONFIG.LOG_FILE $::env(NF_DESIGN_DIR)/test/reg_stim.log] [get_ips axi_sim_transactor_ip]
