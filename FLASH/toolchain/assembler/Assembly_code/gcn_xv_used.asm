...
// assuming HBM memory is byte-addressable
            ...
            addi x6, x0, 0x002 // 4 (TM)
            // LOOP_TK
            addi x30, x0, 0x003 // was 32 before (TK)
...
LOOP_TM:    vsetivli zero, 32, e32, m2 // has to be equal to vmacc_unroll_factor
...
LOOP_TK:    vsetivli zero, 2048, e32, m2 // has to be equal to vmacc_VLEN (EXACT) 1354
            ...
            vsetivli zero, 32, e32, m2// has to be equal to vmacc_unroll_factor
