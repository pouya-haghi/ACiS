...
print("The time of execution of start is :", (e_start_time-s_start_time) * 10**3, "ms")
print("The time of execution of wait is :", (e_wait_time-s_wait_time) * 10**3, "ms")
# ===========================================
# Remote (NIC) 1
import numpy as np
from _thread import *
...
e_send_time = time.time()

# now call lb_wh.wait() from local node
print(udp_message_global)
print(recv_data_global)
print("The time of execution of send is :", (e_send_time-s_send_time) * 10**3, "ms")
print("The time of execution of recv is :", (e_recv_time-s_recv_time) * 10**3, "ms")
# ===========================================
# Remote (NIC) 2
import numpy as np
from _thread import *
