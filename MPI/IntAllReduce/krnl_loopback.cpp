...
#define TDWIDTH 16
#define UWIDTH 96
#define MAX_RANK 8 // Set this to the maximum number of ranks supported
...
void krnl_loopback(hls::stream<pkt> &n2k,    // Internal Stream
                   ...
                   unsigned int num_rank  // Number of ranks being used (0 to MAX_RANK)
                   ) {
...
#pragma HLS INTERFACE axis port = k2n
    ...
    unsigned int buffer_idx[MAX_RANK]; // Array to hold buffer indices for each rank
...
#pragma HLS UNROLL
    ...
    ap_uint<32> acc_buf[MAX_RANK][MAX_BUFFER_SIZE] = {0};
...
#pragma HLS PIPELINE II=1
        ...
        unsigned int buffer_idx_mux = buffer_idx_this_rank;
