; ModuleID = '/home/Will/Documents/Research-Files/G-FPin_HW/Vitis/sw_emu/_x/krnl_s2mm/krnl_s2mm/krnl_s2mm/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_krnl_s2mm_ir(%"struct.ap_uint<512>"* %out, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %n2k, i32 %size) local_unnamed_addr #0 {
entry:
  %out_copy = alloca %"struct.ap_uint<512>", align 512
  %n2k_copy.data = alloca i512
  %n2k_copy.keep = alloca i64
  %n2k_copy.strb = alloca i64
  %n2k_copy.user = alloca i1
  %n2k_copy.last = alloca i1
  %n2k_copy.id = alloca i1
  %n2k_copy.dest = alloca i16
  call fastcc void @copy_in(%"struct.ap_uint<512>"* %out, %"struct.ap_uint<512>"* nonnull align 512 %out_copy, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %n2k, i512* %n2k_copy.data, i64* %n2k_copy.keep, i64* %n2k_copy.strb, i1* %n2k_copy.user, i1* %n2k_copy.last, i1* %n2k_copy.id, i16* %n2k_copy.dest)
  call void @apatb_krnl_s2mm_hw(%"struct.ap_uint<512>"* %out_copy, i512* %n2k_copy.data, i64* %n2k_copy.keep, i64* %n2k_copy.strb, i1* %n2k_copy.user, i1* %n2k_copy.last, i1* %n2k_copy.id, i16* %n2k_copy.dest, i32 %size)
  call fastcc void @copy_out(%"struct.ap_uint<512>"* %out, %"struct.ap_uint<512>"* nonnull align 512 %out_copy, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %n2k, i512* %n2k_copy.data, i64* %n2k_copy.keep, i64* %n2k_copy.strb, i1* %n2k_copy.user, i1* %n2k_copy.last, i1* %n2k_copy.id, i16* %n2k_copy.dest)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"struct.ap_uint<512>"* readonly, %"struct.ap_uint<512>"* noalias align 512, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"*, i512* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.0" %_V_data_V, i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.1" %_V_keep_V, i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.5" %_V_id_V, i16* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.6" %_V_dest_V) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<512>"(%"struct.ap_uint<512>"* align 512 %1, %"struct.ap_uint<512>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"(i512* %_V_data_V, i64* %_V_keep_V, i64* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i16* %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %2)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<512>"(%"struct.ap_uint<512>"* noalias align 512, %"struct.ap_uint<512>"* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"(i512* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.5" %_V_id_V, i16* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"(i512* %_V_data_V, i64* %_V_keep_V, i64* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i16* %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* nonnull %0)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"(i512* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i64* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i64* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.5" %_V_id_V, i16* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"struct.ap_uint<512>"*, %"struct.ap_uint<512>"* noalias readonly align 512, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"*, i512* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.0" %_V_data_V, i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.1" %_V_keep_V, i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.5" %_V_id_V, i16* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.6" %_V_dest_V) unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<512>"(%"struct.ap_uint<512>"* %0, %"struct.ap_uint<512>"* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>.4"(%"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %2, i512* %_V_data_V, i64* %_V_keep_V, i64* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i16* %_V_dest_V)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>.4"(%"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", i512* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.5" %_V_id_V, i16* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.6" %_V_dest_V) unnamed_addr #3 {
entry:
  %1 = icmp eq %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %0, null
  %2 = or i1 %1, false
  br i1 %2, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>.7"(%"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* nonnull align 512 %0, i512* %_V_data_V, i64* %_V_keep_V, i64* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i16* %_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>.7"(%"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", i512* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i64* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i64* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.5" %_V_id_V, i16* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.6" %_V_dest_V) unnamed_addr #4 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"
  %2 = alloca i512
  %3 = alloca i64
...
declare void @apatb_krnl_s2mm_hw(%"struct.ap_uint<512>"*, i512*, i64*, i64*, i1*, i1*, i1*, i16*, i32)

define void @krnl_s2mm_hw_stub_wrapper(%"struct.ap_uint<512>"*, i512*, i64*, i64*, i1*, i1*, i1*, i16*, i32) #6 {
entry:
  %9 = alloca %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"
  call void @copy_out(%"struct.ap_uint<512>"* null, %"struct.ap_uint<512>"* %0, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %9, i512* %1, i64* %2, i64* %3, i1* %4, i1* %5, i1* %6, i16* %7)
  call void @krnl_s2mm_hw_stub(%"struct.ap_uint<512>"* %0, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %9, i32 %8)
  call void @copy_in(%"struct.ap_uint<512>"* null, %"struct.ap_uint<512>"* %0, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %9, i512* %1, i64* %2, i64* %3, i1* %4, i1* %5, i1* %6, i16* %7)
  ret void
}

declare void @krnl_s2mm_hw_stub(%"struct.ap_uint<512>"*, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"*, i32)
