; ModuleID = '/home/Will/Documents/Research-Files/G-FPin_HW/Vitis/sw_emu/_x/krnl_mm2s/krnl_mm2s/krnl_mm2s/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  %in_copy = alloca %"struct.ap_uint<512>", align 512
  ...
  call fastcc void @copy_in(%"struct.ap_uint<512>"* %in, %"struct.ap_uint<512>"* nonnull align 512 %in_copy, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %k2n, i512* %k2n_copy.data, i64* %k2n_copy.keep, i64* %k2n_copy.strb, i1* %k2n_copy.user, i1* %k2n_copy.last, i1* %k2n_copy.id, i16* %k2n_copy.dest)
  call void @apatb_krnl_mm2s_hw(%"struct.ap_uint<512>"* %in_copy, i512* %k2n_copy.data, i64* %k2n_copy.keep, i64* %k2n_copy.strb, i1* %k2n_copy.user, i1* %k2n_copy.last, i1* %k2n_copy.id, i16* %k2n_copy.dest, i32 %size, i32 %dest)
  call fastcc void @copy_out(%"struct.ap_uint<512>"* %in, %"struct.ap_uint<512>"* nonnull align 512 %in_copy, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %k2n, i512* %k2n_copy.data, i64* %k2n_copy.keep, i64* %k2n_copy.strb, i1* %k2n_copy.user, i1* %k2n_copy.last, i1* %k2n_copy.id, i16* %k2n_copy.dest)
  ret void
}
...
declare void @apatb_krnl_mm2s_hw(%"struct.ap_uint<512>"*, i512*, i64*, i64*, i1*, i1*, i1*, i16*, i32, i32)

define void @krnl_mm2s_hw_stub_wrapper(%"struct.ap_uint<512>"*, i512*, i64*, i64*, i1*, i1*, i1*, i16*, i32, i32) #6 {
entry:
  %10 = alloca %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"
  call void @copy_out(%"struct.ap_uint<512>"* null, %"struct.ap_uint<512>"* %0, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %10, i512* %1, i64* %2, i64* %3, i1* %4, i1* %5, i1* %6, i16* %7)
  call void @krnl_mm2s_hw_stub(%"struct.ap_uint<512>"* %0, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %10, i32 %8, i32 %9)
  call void @copy_in(%"struct.ap_uint<512>"* null, %"struct.ap_uint<512>"* %0, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %10, i512* %1, i64* %2, i64* %3, i1* %4, i1* %5, i1* %6, i16* %7)
  ret void
}
