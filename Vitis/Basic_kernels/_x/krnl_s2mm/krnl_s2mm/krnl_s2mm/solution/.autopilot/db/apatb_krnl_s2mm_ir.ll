; ModuleID = '/home/Will/Documents/Research-Files/G-FPin_HW/Vitis/Basic_kernels/_x/krnl_s2mm/krnl_s2mm/krnl_s2mm/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call fastcc void @copy_in(%"struct.ap_uint<512>"* %out, i512* nonnull align 512 %out_copy, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %n2k, i512* %n2k_copy.data, i64* %n2k_copy.keep, i64* %n2k_copy.strb, i1* %n2k_copy.user, i1* %n2k_copy.last, i1* %n2k_copy.id, i16* %n2k_copy.dest)
  call void @apatb_krnl_s2mm_hw(i512* %out_copy, i512* %n2k_copy.data, i64* %n2k_copy.keep, i64* %n2k_copy.strb, i1* %n2k_copy.user, i1* %n2k_copy.last, i1* %n2k_copy.id, i16* %n2k_copy.dest, i32 %size)
  call fastcc void @copy_out(%"struct.ap_uint<512>"* %out, i512* nonnull align 512 %out_copy, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %n2k, i512* %n2k_copy.data, i64* %n2k_copy.keep, i64* %n2k_copy.strb, i1* %n2k_copy.user, i1* %n2k_copy.last, i1* %n2k_copy.id, i16* %n2k_copy.dest)
  ret void
}
...
declare void @apatb_krnl_s2mm_hw(i512*, i512*, i64*, i64*, i1*, i1*, i1*, i16*, i32)

define void @krnl_s2mm_hw_stub_wrapper(i512*, i512*, i64*, i64*, i1*, i1*, i1*, i16*, i32) #6 {
entry:
  %9 = alloca %"struct.ap_uint<512>"
  %10 = alloca %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"
  call void @copy_out(%"struct.ap_uint<512>"* %9, i512* %0, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %10, i512* %1, i64* %2, i64* %3, i1* %4, i1* %5, i1* %6, i16* %7)
  call void @krnl_s2mm_hw_stub(%"struct.ap_uint<512>"* %9, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %10, i32 %8)
  call void @copy_in(%"struct.ap_uint<512>"* %9, i512* %0, %"class.hls::stream<hls::axis<ap_uint<512>, 1, 1, 16>, 0>"* %10, i512* %1, i64* %2, i64* %3, i1* %4, i1* %5, i1* %6, i16* %7)
  ret void
}
