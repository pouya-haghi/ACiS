...
// ==============================================================
`timescale 1ns/1ps
module krnl_mm2s_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_DEST_DATA_0 = 6'h24,
    ADDR_DEST_CTRL   = 6'h28,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_DEST_DATA_0)
            int_dest[31:0] <= (WDATA[31:0] & wmask) | (int_dest[31:0] & ~wmask);
    end
end
