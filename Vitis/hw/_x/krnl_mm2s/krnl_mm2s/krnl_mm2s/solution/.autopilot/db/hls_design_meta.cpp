...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("k2n_TDATA", 512, hls_out, 2, "axis", "out_data", 1),
	Port_Property("k2n_TVALID", 1, hls_out, 8, "axis", "out_vld", 1),
	Port_Property("k2n_TREADY", 1, hls_in, 8, "axis", "out_acc", 1),
	Port_Property("k2n_TKEEP", 64, hls_out, 3, "axis", "out_data", 1),
	Port_Property("k2n_TSTRB", 64, hls_out, 4, "axis", "out_data", 1),
	Port_Property("k2n_TUSER", 1, hls_out, 5, "axis", "out_data", 1),
	Port_Property("k2n_TLAST", 1, hls_out, 6, "axis", "out_data", 1),
	Port_Property("k2n_TID", 1, hls_out, 7, "axis", "out_data", 1),
	Port_Property("k2n_TDEST", 16, hls_out, 8, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "krnl_mm2s";
