...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("n2k_TDATA", 512, hls_in, 2, "axis", "in_data", 1),
	Port_Property("n2k_TVALID", 1, hls_in, 8, "axis", "in_vld", 1),
	Port_Property("n2k_TREADY", 1, hls_out, 8, "axis", "in_acc", 1),
	Port_Property("n2k_TKEEP", 64, hls_in, 3, "axis", "in_data", 1),
	Port_Property("n2k_TSTRB", 64, hls_in, 4, "axis", "in_data", 1),
	Port_Property("n2k_TUSER", 1, hls_in, 5, "axis", "in_data", 1),
	Port_Property("n2k_TLAST", 1, hls_in, 6, "axis", "in_data", 1),
	Port_Property("n2k_TID", 1, hls_in, 7, "axis", "in_data", 1),
	Port_Property("n2k_TDEST", 16, hls_in, 8, "axis", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "krnl_s2mm";
